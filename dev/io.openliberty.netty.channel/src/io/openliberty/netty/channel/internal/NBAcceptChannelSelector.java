...
import io.openliberty.netty.channel.internal.NBAccept;
import io.openliberty.netty.channel.internal.NBAcceptChannelSelector;
...
import io.openliberty.netty.channel.internal.NBAccept.EndPointActionInfo;
...
public class NBAcceptChannelSelector extends ChannelSelector implements FFDCSelfIntrospectable {
    ...
    protected void updateSelector() {
        ...
        if (trace)
            Tr.entry(this, tc, "updateSelector");
        ...
        if (trace)
            Tr.exit(this, tc, "updateSelector");
    }
